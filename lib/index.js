...
exports.createClientWithBasicAuth = function createClientWithBasicAuth(kwargs) {
    console.error('deprecated... will be removed in the future... use createClient or createClientWithIntegration... and pass in kwargs');
...
exports.createClientWithIntegration = function createClientWithIntegration(kwargs) {
    let token = kwargs['token'];
    let examId = kwargs['examId'];
